...
namespace ExpRddApp
{
    public static class AcadTools
    {
        ...
        public static List<elements.Block> GetBlocks(ref bool error, Database db, Dictionary<string, string> blocksToGet)
        {
            List<elements.Block> Blocks = new List<elements.Block>();
